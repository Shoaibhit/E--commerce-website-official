...
if(isset($_POST['insert_brand'])){
    ...
    if($result){
      echo "<script> alert('brand sucessfully added') </script>";
    }
}}
?>
...
<form action="" method="post" class="mb2">
  ...
  <input type="text" class="form-control" name="brand_title" placeholder="insert brand" aria-label="inset brand" aria-describedby="basic-addon1">
</div>
